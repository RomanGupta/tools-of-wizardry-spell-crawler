...
public class ExpectedNoOfSpellsPerClassAndLevelForAdvancedPlayersGuide implements ExpectedNoOfSpellsPerClassAndLevelForSource {
...

    {
        ...
        expectedSpellsForBard.put(0, 3);
        expectedSpellsForBard.put(1, 15);
        expectedSpellsForBard.put(2, 10);
        expectedSpellsForBard.put(3, 11);
        expectedSpellsForBard.put(4, 6);
        expectedSpellsForBard.put(5, 9);
        expectedSpellsForBard.put(6, 6);
        expectedNoOfSpells.put(BARD, expectedSpellsForBard);
        // Cleric
        Map<Integer, Integer> expectedSpellsForCleric = new HashMap<>();
        expectedSpellsForCleric.put(0, 1);
        expectedSpellsForCleric.put(1, 2);
        expectedSpellsForCleric.put(2, 6);
        expectedSpellsForCleric.put(3, 7);
        expectedSpellsForCleric.put(4, 4);
        expectedSpellsForCleric.put(5, 6);
        expectedSpellsForCleric.put(6, 1);
        expectedSpellsForCleric.put(7, 0);
        expectedSpellsForCleric.put(8, 2);
        expectedSpellsForCleric.put(9, 1);
        expectedNoOfSpells.put(CLERIC, expectedSpellsForCleric);
        // Druid
        Map<Integer, Integer> expectedSpellsForDruid = new HashMap<>();
        expectedSpellsForDruid.put(0, 1);
        expectedSpellsForDruid.put(1, 15);
        expectedSpellsForDruid.put(2, 15);
        expectedSpellsForDruid.put(3, 10);
        expectedSpellsForDruid.put(4, 11);
        expectedSpellsForDruid.put(5, 6);
        expectedSpellsForDruid.put(6, 2);
        expectedSpellsForDruid.put(7, 2);
        expectedSpellsForDruid.put(8, 4);
        expectedSpellsForDruid.put(9, 4);
        expectedNoOfSpells.put(DRUID, expectedSpellsForDruid);
        // Paladin
        Map<Integer, Integer> expectedSpellsForPaladin = new HashMap<>();
        expectedSpellsForPaladin.put(1, 8);
        expectedSpellsForPaladin.put(2, 13);
        expectedSpellsForPaladin.put(3, 7);
        expectedSpellsForPaladin.put(4, 8);
        expectedNoOfSpells.put(PALADIN, expectedSpellsForPaladin);
        // Ranger
        Map<Integer, Integer> expectedSpellsForRanger = new HashMap<>();
        expectedSpellsForRanger.put(1, 15);
        expectedSpellsForRanger.put(2, 18);
        expectedSpellsForRanger.put(3, 9);
        expectedSpellsForRanger.put(4, 4);
        expectedNoOfSpells.put(RANGER, expectedSpellsForRanger);
        // Sorcerer
        Map<Integer, Integer> expectedSpellsForSorcerer = new HashMap<>();
        expectedSpellsForSorcerer.put(0, 1);
        expectedSpellsForSorcerer.put(1, 17);
        expectedSpellsForSorcerer.put(2, 13);
        expectedSpellsForSorcerer.put(3, 15);
        expectedSpellsForSorcerer.put(4, 12);
        expectedSpellsForSorcerer.put(5, 9);
        expectedSpellsForSorcerer.put(6, 7);
        expectedSpellsForSorcerer.put(7, 8);
        expectedSpellsForSorcerer.put(8, 4);
        expectedSpellsForSorcerer.put(9, 7);
        expectedNoOfSpells.put(SORCERER, expectedSpellsForSorcerer);
        // Wizard
        Map<Integer, Integer> expectedSpellsForWizard = new HashMap<>();
        expectedSpellsForWizard.put(0, 1);
        expectedSpellsForWizard.put(1, 17);
        expectedSpellsForWizard.put(2, 13);
        expectedSpellsForWizard.put(3, 15);
        expectedSpellsForWizard.put(4, 12);
        expectedSpellsForWizard.put(5, 9);
        expectedSpellsForWizard.put(6, 7);
        expectedSpellsForWizard.put(7, 8);
        expectedSpellsForWizard.put(8, 4);
        expectedSpellsForWizard.put(9, 7);
        ...
        expectedSpellsForAntipaladin.put(2, 1);
        expectedSpellsForAntipaladin.put(3, 1);
        expectedSpellsForAntipaladin.put(4, 1);
        ...
        expectedSpellsForAlchemist.put(1, 7);
        expectedSpellsForAlchemist.put(2, 6);
        expectedSpellsForAlchemist.put(3, 7);
        expectedSpellsForAlchemist.put(4, 4);
        ...
        expectedSpellsForInquisitor.put(0, 2);
        expectedSpellsForInquisitor.put(1, 3);
        expectedSpellsForInquisitor.put(2, 11);
        expectedSpellsForInquisitor.put(3, 11);
        expectedSpellsForInquisitor.put(4, 10);
        expectedSpellsForInquisitor.put(5, 4);
        expectedSpellsForInquisitor.put(6, 2);
        ...
        expectedSpellsForOracle.put(2, 1);
        expectedSpellsForOracle.put(3, 1);
        ...
        expectedSpellsForOracle.put(8, 1);
        ...
        expectedSpellsForSummoner.put(2, 4);
        expectedSpellsForSummoner.put(3, 6);
        expectedSpellsForSummoner.put(4, 4);
        expectedSpellsForSummoner.put(5, 3);
        expectedSpellsForSummoner.put(6, 1);
        expectedNoOfSpells.put(SUMMONER, expectedSpellsForSummoner);
        // Witch
        Map<Integer, Integer> expectedSpellsForWitch = new HashMap<>();
        expectedSpellsForWitch.put(0, 2);
        expectedSpellsForWitch.put(1, 4);
        expectedSpellsForWitch.put(2, 8);
        expectedSpellsForWitch.put(3, 8);
        expectedSpellsForWitch.put(4, 5);
        expectedSpellsForWitch.put(5, 4);
        expectedSpellsForWitch.put(6, 4);
        expectedSpellsForWitch.put(7, 0);
        expectedSpellsForWitch.put(8, 1);
        expectedSpellsForWitch.put(9, 1);
